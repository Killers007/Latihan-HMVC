...
class Crud extends MX_Controller {
	...
	function __construct(){
		// $this->session->set_userdata('login','Juhdi');
	...
	public function index()
	{
		...
		// show_error('Anjayy',403);
		// show_404();
		redirect(base_url('crud/tabel/menu_crud'));
		...
		// 		'relasi' => $this->db->get_where('menu_crud',array('tabel'=> $this->session->userdata('tabel')))->row()
		// 	)
		// );
		// echo "<pre>";
