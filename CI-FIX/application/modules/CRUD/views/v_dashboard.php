...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <?php if ($this->uri->segment(3)!='menu_crud'): ?>
      <h1><i class="<?php echo $relasi->icon ?>">  </i> 
        <?php echo $relasi->nama_menu ?>
        <small></small>
      </h1>
    <?php endif ?>
    <?php if ($this->uri->segment(3)=='menu_crud'): ?>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <h4 class="modal-title"><i class="fa fa-book"></i>  Dokumentasi Relasi</h4>
            </div>
            <div class="modal-body">
              <form method="post" class="form-update">
                <div class="box-body">
                  <div class="form-group">
                    <p class="margin">ID:<br><code>Urutan Pada Menu | <i>note : tidak boleh sama</i></code></p>
                  </div>
                  <div class="form-group">
                    <p class="margin">Icon:<br><code>Contoh : fa fa-pencil (<i class="fa fa-pencil"></i>) -> pada fontwasome</code> </p>
                  </div>
                  <div class="form-group">
                    <p class="margin">Nama Menu:<br><code>Menampilkan pada menu sidebar</code></p>
                  </div>
                  <div class="form-group">
                    <p class="margin">Tabel:<br><code>Pilih tabel yang ingin digunakan</code></p>
                  </div>
                  <div class="form-group">
                    <p class="margin">Relasi:<br>
                      <code>
                        Format : <br>
                        <i>
                          1. Nama field yang berelasi | Tabel Utama<br>
                          2. Nama tabel referensi  | Tabel Referensi<br>
                          3. Nama referensi field relasi | Tabel Referensi<br>
                          4. Nama field yang akan ditampilkan pada combobox | Tabel Referensi<br><br>
                        </i>
                        Contoh :<br>
                        [<br>
                        &nbsp;['<i>1</i>','<i>2</i>','<i>3</i>','<i>4</i>']<br>
                        &nbsp;,['cth. field_kode','cth. tabel_ref','cth. field_kode','cth. field_nama'] <i>// Jika tabel relasi lebih dari 1 dst.</i><br>
                        ]<br>
                      </code>
                    </p>
                  </div>
            ...
            <div class="modal-footer">
              ...
              <a type="button" class="btn btn-success pull-right" href="<?php echo base_url('crud/tabel/menu_crud'); ?>">Atur Menu</a>
            </div>
          </div>
        </div>
      </div>
